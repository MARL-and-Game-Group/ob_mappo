...
class SMACRunner(Runner):
            ...
            for step in range(self.episode_length):
                ...
                if self.all_args.use_q_head:
                    data = obs, share_obs, rewards, dones, infos, available_actions, \
                           q_values, values, actions, action_log_probs, \
                           rnn_states, rnn_states_critic, pi, ob
                else:
                    data = obs, share_obs, rewards, dones, infos, available_actions, \
    ...
    def collect(self, step):
        ...
        if self.all_args.use_q_head:
            q_values, value, action, action_log_prob, rnn_state, rnn_state_critic, pi \
        ...
        if self.all_args.use_q_head:
            return q_values, values, actions, action_log_probs, rnn_states, rnn_states_critic, pi
        else:
    ...
    def insert(self, data):
        if self.all_args.use_q_head:
            ...
            q_values, values, actions, action_log_probs, rnn_states, rnn_states_critic, pi, ob = data
        else:
            obs, share_obs, rewards, dones, infos, available_actions, \
        ...
        if self.all_args.use_q_head:
            self.buffer.insert(share_obs, obs, rnn_states, rnn_states_critic,
                               actions, action_log_probs, q_values, values, pi, ob, rewards, masks, bad_masks, active_masks,available_actions)
        else:
            self.buffer.insert(share_obs, obs, rnn_states, rnn_states_critic,
                               actions, action_log_probs, None, values, None, rewards, masks, bad_masks, active_masks,
                               available_actions)
