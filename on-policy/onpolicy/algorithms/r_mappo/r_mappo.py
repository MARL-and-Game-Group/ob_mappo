...
class R_MAPPO():
    ...
    def ppo_update(self, sample, update_actor=True):
        ...
        if self.args.use_q_head:
            ...
            if self._use_max_grad_norm:
                critic_grad_norm = nn.utils.clip_grad_norm_(self.policy.q_head.parameters(), self.max_grad_norm)
            else:
                critic_grad_norm = get_gard_norm(self.policy.q_head.parameters())
